...
This project is the Agora Voice and AI Agent module for the Sentinel incident response platform.

### Responsibilities

The Agora Voice module is responsible for:

- Joining an Agora voice room.
- Running the Sentinel AI voice agent.
- Capturing live conversation transcripts.
- Preserving speaker identity.
- Forwarding final transcript events to the Incident Intelligence service.
- Maintaining the voice conversation lifecycle.
